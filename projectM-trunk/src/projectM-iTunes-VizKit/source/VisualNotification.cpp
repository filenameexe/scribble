...
VisualNotification *VisualNotification::clone(void) const const
{
...
void *VisualNotification::getData(uint32 & dataSizeInBytes) const const
{
...
VisualObject *VisualNotification::getObject() const const
{
