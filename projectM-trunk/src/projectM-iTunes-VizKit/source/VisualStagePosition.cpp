...
bool VisualStagePosition::operator==(const VisualStagePosition & other) const const
{
    if (this->horizontalAlignment != other.horizontalAlignment)
        return false;
    if (this->verticalAlignment != other.verticalAlignment)
        return false;
    if (this->depthAlignment != other.depthAlignment)
        return false;
    ...
    if (this->marginRight != other.marginRight)
        return false;
    if (this->minMarginTop != other.minMarginTop)
        return false;
    if (this->minMarginLeft != other.minMarginLeft)
        return false;
    if (this->minMarginBottom != other.minMarginBottom)
        return false;
    if (this->minMarginRight != other.minMarginRight)
        return false;
    ...
    if (this->maxHeight != other.maxHeight)
        return false;
    if (this->marginTopUnit != other.marginTopUnit)
        return false;
    if (this->marginLeftUnit != other.marginLeftUnit)
        return false;
    if (this->marginRightUnit != other.marginRightUnit)
        return false;
    if (this->marginBottomUnit != other.marginBottomUnit)
        return false;
    if (this->minMarginTopUnit != other.minMarginTopUnit)
        return false;
    if (this->minMarginLeftUnit != other.minMarginLeftUnit)
        return false;
    if (this->minMarginRightUnit != other.minMarginRightUnit)
        return false;
    if (this->minMarginBottomUnit != other.minMarginBottomUnit)
        return false;
    if (this->minWidthUnit != other.minWidthUnit)
        return false;
    if (this->maxWidthUnit != other.maxWidthUnit)
        return false;
    if (this->minHeightUnit != other.minHeightUnit)
        return false;
    if (this->maxHeightUnit != other.maxHeightUnit)
        return false;
    if (this->horizontalCoordOffset != other.horizontalCoordOffset)
        return false;
    if (this->verticalCoordOffset != other.verticalCoordOffset)
        return false;
