...
void VisualGraphicsCore::setViewport(const BottomLeftPositionedPixelRect & canvasRect, const bool isFullscreen)
{
    ...
    if (isFullscreen == true) {
        ...
        glScissor(canvasRect.bottomLeftPixel.x, canvasRect.bottomLeftPixel.y, (GLsizei) canvasRect.pixelRect.width,
                  (GLsizei) canvasRect.pixelRect.height);
        viewportBottomLeft.x = canvasRect.bottomLeftPixel.x;
        viewportBottomLeft.y = canvasRect.bottomLeftPixel.y;
    }
#endif

    glViewport((GLint) viewportBottomLeft.x, (GLint) viewportBottomLeft.y, (GLsizei) canvasRect.pixelRect.width,
               (GLsizei) canvasRect.pixelRect.height);
