                                                   ...
                                                   double *xCoordPos, double *yCoordPos, double *zCoordPos)
{
    ...
    return theVisualGraphics->getCoordsOfPixelPosition(xPixelPos + bottomLeftViewportOrigin.x,
                                                       yPixelPos + bottomLeftViewportOrigin.y, zAxisPos, xCoordPos,
                                                       yCoordPos, zCoordPos);
}
...
void VisualActorGraphics::drawSpot(const double xNum, const double yNum, const double r, const double g, const double b,
...
void VisualActorGraphics::drawWaveform(const sint16 historyNum, const uint16 maxNumberOfHistories,
                                       ...
                                       const sint16 ** const waveformDataMonoArray, const VisualCamera & aCamera)
{
    VisualGraphics *theVisualGraphics = VisualGraphics::getInstance();
    theVisualGraphics->drawWaveform(historyNum, maxNumberOfHistories, numberOfWaveformEntries,
                                    const_cast < sint16 ** >(waveformDataMonoArray), aCamera);
}
                                               ...
                                               const uint8 *** const spectrumDataArray, const VisualCamera & aCamera)
{
    ...
    theVisualGraphics->drawSpectrumAnalyzer(currHistoryNum, numberOfHistories, numberOfSpectrumEntries,
                                            numberOfAudioChannels, spectrumDataArray, aCamera);
}
