...
VisualNurbs::VisualNurbs(uint8 sKnotsCount, float *sKnotsPointer, uint8 tKnotsCount, float *tKnotsPointer,
                         uint16 s_Stride, uint16 t_Stride, uint16 s_Order, uint16 t_Order)
{
...
void VisualNurbs::setTexture(uint8 sKnotsCount, float *sKnotsPointer, uint8 tKnotsCount, float *tKnotsPointer,
                             uint16 s_Stride, uint16 t_Stride, uint16 s_Order, uint16 t_Order, uint32 aTextureName,
...
void VisualNurbs::draw()
{
    ...
    gluNurbsSurface(this->nurbsObject,
                    ...
                    this->tNumKnots,
                    this->tKnots,
                    this->sStride, this->tStride, this->controlPoints, this->sOrder, this->tOrder, GL_MAP2_VERTEX_3);
