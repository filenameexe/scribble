...
const FTTesselation *const FTMesh::Tesselation(unsigned int index) const const
{
...
:  contourList(0), mesh(0), ftContourCount(0), contourFlag(0)
{
    if (glyph) {
...
const FTContour *const FTVectoriser::Contour(unsigned int index) const const
{
