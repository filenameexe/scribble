...
unsigned int FTGlyphContainer::FontIndex(const unsigned int characterCode) const const
{
...
const FTGlyph *const FTGlyphContainer::Glyph(const unsigned int characterCode) const const
{
...
FTBBox FTGlyphContainer::BBox(const unsigned int characterCode) const const
{
...
FTPoint FTGlyphContainer::Render(const unsigned int characterCode, const unsigned int nextCharacterCode,
                                 FTPoint penPosition)
{
