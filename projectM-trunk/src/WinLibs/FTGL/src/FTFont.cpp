...
unsigned int FTFont::FaceSize() const const
{
...
float FTFont::Ascender() const const
{
    return charSize.Ascender();
}


float FTFont::Descender() const const
{
    return charSize.Descender();
}

float FTFont::LineHeight() const const
{
...
void FTFont::BBox(const wchar_t * string, float &llx, float &lly, float &llz, float &urx, float &ury, float &urz)
{
    FTBBox totalBBox;
