...
void PipelineMerger::mergePipelines(const Pipeline & a, const Pipeline & b, Pipeline & out,
                                    RenderItemMatcher::MatchResults & results, RenderItemMergeFunction & mergeFunction,
                                    float ratio)
{
    ...
    for (std::vector < RenderItem * >::const_iterator pos = b.drawables.begin(); pos != b.drawables.end(); ++pos) {
