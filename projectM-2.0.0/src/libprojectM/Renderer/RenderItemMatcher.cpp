...
double RenderItemMatcher::computeMatching(const RenderItemList & lhs, const RenderItemList & rhs) const const
{
...
void RenderItemMatcher::setMatches(const RenderItemList & lhs_src, const RenderItemList & rhs_src)
const {
