...
void VisualAnimation::start()
{
    ...
    if (this->currentValueIsSet == true) {
        ...
        if ((this->minimumClampValueIsSet == true) && (this->currentValue < this->minimumClampValue)) {
            if ((this->theTimeline->getMovingDirection() == kForward)
                && (theTimeline->getStartValue() > theTimeline->getEndValue())) {
                this->theTimeline->setMovingDirection(kBackward);
            } else if ((this->theTimeline->getMovingDirection() == kBackward)
                       && (theTimeline->getEndValue() > theTimeline->getStartValue())) {
...
const AnimatedProperty VisualAnimation::getAnimatedProperty() const const
{
...
const bool VisualAnimation::isDead(void) const const
{
...
const VisualItemIdentifier *const VisualAnimation::getIdentifier() const const
{
