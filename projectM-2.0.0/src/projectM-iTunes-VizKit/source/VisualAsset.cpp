...
VertexChain *VisualAsset::generateVertexChain(VertexChainName vertexChainName, double scaleFactor)
{
    ...
    if (vertexChainName == kFrontVertexChain) {
        ...
        if (this->vertexChainFront != NULL) {
            for (VertexChainIterator chainIt = this->vertexChainFront->begin();
                 chainIt != this->vertexChainFront->end(); chainIt++) {
                delete *chainIt;
                *chainIt = NULL;
            }
        ...
        if (this->vertexChainTop != NULL) {
            for (VertexChainIterator chainIt = this->vertexChainTop->begin(); chainIt != this->vertexChainTop->end();
                 chainIt++) {
                delete *chainIt;
                *chainIt = NULL;
            }
        ...
        if (this->vertexChainLeft != NULL) {
            for (VertexChainIterator chainIt = this->vertexChainLeft->begin(); chainIt != this->vertexChainLeft->end();
                 chainIt++) {
                delete *chainIt;
                *chainIt = NULL;
            }
        ...
        if (this->vertexChainRight != NULL) {
            for (VertexChainIterator chainIt = this->vertexChainRight->begin();
                 chainIt != this->vertexChainRight->end(); chainIt++) {
                delete *chainIt;
                *chainIt = NULL;
            }
        ...
        if (this->vertexChainBack != NULL) {
            for (VertexChainIterator chainIt = this->vertexChainBack->begin(); chainIt != this->vertexChainBack->end();
                 chainIt++) {
                delete *chainIt;
                *chainIt = NULL;
            }
        ...
        if (this->vertexChainBottom != NULL) {
            for (VertexChainIterator chainIt = this->vertexChainBottom->begin();
                 chainIt != this->vertexChainBottom->end(); chainIt++) {
                delete *chainIt;
                *chainIt = NULL;
            }
...
const VisualItemIdentifier *const VisualAsset::addAnimation(VisualAnimation & anAnimation,
                                                            AnimationAttachmentMode animationAttachmentMode)
{

    if (anAnimation.getAnimatedProperty() != kCustomAnimatedProperty) {
        VisualStageControl::removeVisualAnimationsWithOwnerIdentifier(*this->assetIdentifier,
                                                                      anAnimation.getAnimatedProperty());
    }
                ...
                if (aTimeline->getMovingDirection() == kForward) {
                    if (currStartValue < currEndValue) {
                        startDelayInMilliseconds =
                            (UInt32) ((double) durationInMilliseconds *
                                      ((this->opacityValue - currStartValue) / distance));
                    } else {
                        startDelayInMilliseconds =
                            (UInt32) ((double) durationInMilliseconds *
                                      ((currStartValue - this->opacityValue) / distance));
                    }
                } else if (aTimeline->getMovingDirection() == kBackward) {
                    if (currStartValue < currEndValue) {
                        startDelayInMilliseconds =
                            (UInt32) ((double) durationInMilliseconds *
                                      ((currEndValue - this->opacityValue) / distance));
                    } else {
                        startDelayInMilliseconds =
                            (UInt32) ((double) durationInMilliseconds *
                                      ((this->opacityValue - currEndValue) / distance));
                    }
                }
            }
