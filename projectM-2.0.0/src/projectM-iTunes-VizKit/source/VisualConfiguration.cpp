...
void VisualConfiguration::setDefaultPreferences()
{
    ...
    VisualDataStore::setDefaultPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorBottomRightGreen,
                                                    1.0f);
    VisualDataStore::setDefaultPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorBottomRightBlue, 1.0f);
    VisualDataStore::setDefaultPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorBottomRightAlpha,
                                                    1.0f);
