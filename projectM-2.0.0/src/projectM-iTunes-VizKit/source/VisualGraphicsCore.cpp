...
UInt8 VisualGraphicsCore::setupAGL()
{
    ...
    GLint attrib[] =
        { AGL_RGBA, AGL_RED_SIZE, 8, AGL_GREEN_SIZE, 8, AGL_BLUE_SIZE, 8, AGL_ALPHA_SIZE, 8, AGL_ACCELERATED,
AGL_DOUBLEBUFFER, AGL_DEPTH_SIZE, 24, AGL_CLOSEST_POLICY, AGL_NONE };
...
void VisualGraphicsCore::setViewport(const::Rect * const canvasRect, const::Rect * const canvasSurroundingRect,
                                     const bool isFullscreen)
{
    ...
    if (isFullscreen == true) {
        ...
        theVisualGraphicsCore->canvasYOriginOffset =
            (canvasSurroundingRect->bottom - canvasSurroundingRect->top - canvasRect->bottom);

        glEnable(GL_SCISSOR_TEST);
        glScissor((GLint) theVisualGraphicsCore->canvasXOriginOffset,
                  (GLint) theVisualGraphicsCore->canvasYOriginOffset, (GLsizei) viewportWidth,
