...
void VisualStageBox::calcCoords()
{
    ...
    this->coordWidth =
        theVisualGraphics->getCanvasCoordWidth() * ((double) this->contentPixelWidth /
                                                    theVisualGraphics->getCanvasPixelWidth());
    this->coordHeight =
        theVisualGraphics->getCanvasCoordHeight() * ((double) this->contentPixelHeight /
    ...
    if (this->stagePosition.minMarginBottom != 0.0) {
        if (this->stagePosition.minMarginBottomUnit == kPercent) {
            minMarginBottomCoord =
                theVisualGraphics->getCanvasCoordHeight() * (this->stagePosition.minMarginBottom / 100.0);
    ...
    if (this->stagePosition.minMarginRight != 0.0) {
        if (this->stagePosition.minMarginRightUnit == kPercent) {
            minMarginRightCoord =
                theVisualGraphics->getCanvasCoordWidth() * (this->stagePosition.minMarginRight / 100.0);
    ...
    if ((this->scalingBehaviour & kScalingAllowed) == kScalingAllowed) {
        ...
        if (this->stagePosition.minWidth > 0.0) {
            ...
            if ((this->stagePosition.minWidthUnit == kPercent)
                && ((coordWidth / theVisualGraphics->getCanvasCoordWidth() * 100.0) < this->stagePosition.minWidth)) {
                coordWidth = this->stagePosition.minWidth * theVisualGraphics->getCanvasCoordWidth() / 100.0;
                if (coordWidth >
                    (theVisualGraphics->getCanvasCoordWidth() - (minMarginLeftCoord + minMarginRightCoord))) {
                ...
                if ((this->scalingBehaviour & kPreserveAspectRatio) == kPreserveAspectRatio) {
                    coordHeight = coordHeight * (coordWidth / prevCoordVal);
                       ...
                       && (static_cast < double >(theVisualGraphics->xCoordToPixel(coordWidth)) <
        ...
        if (this->stagePosition.minHeight > 0.0) {
            ...
            if ((this->stagePosition.minHeightUnit == kPercent)
                && ((coordHeight / theVisualGraphics->getCanvasCoordHeight() * 100.0) <
                    this->stagePosition.minHeight)) {
                coordHeight = this->stagePosition.minHeight * theVisualGraphics->getCanvasCoordHeight() / 100.0;
                if (coordHeight >
                    (theVisualGraphics->getCanvasCoordHeight() - (minMarginTopCoord + minMarginBottomCoord))) {
                ...
                if ((this->scalingBehaviour & kPreserveAspectRatio) == kPreserveAspectRatio) {
                    coordWidth = coordWidth * (coordHeight / prevCoordVal);
                       ...
                       && (static_cast < double >(theVisualGraphics->yCoordToPixel(coordHeight)) <
                           this->stagePosition.minHeight)) {
        ...
        if (this->stagePosition.maxWidth > 0.0) {
            ...
            if ((this->stagePosition.maxWidthUnit == kPercent)
                && ((coordWidth / theVisualGraphics->getCanvasCoordWidth() * 100.0) > this->stagePosition.maxWidth)) {
...
*/
    ...
    if (this->stagePosition.verticalAlignment == kTopAligned) {
        ...
        finalMarginBottomCoord =
            (theVisualGraphics->getCanvasCoordHeight() / 2.0) - (coordHeight / 2.0) - marginBottomCoord;
        ...
        if ((coordHeight / 2.0) >= (theVisualGraphics->getCanvasCoordHeight() / 2.0) - minMarginBottomCoord) {
            ...
            if ((finalMarginTopCoord + coordHeight + finalMarginBottomCoord) >
                theVisualGraphics->getCanvasCoordHeight()) {
                finalMarginTopCoord = minMarginTopCoord;
                prevCoordVal = coordHeight;
...
*/
        finalMarginLeftCoord = (theVisualGraphics->getCanvasCoordWidth() / 2.0) - (coordWidth / 2.0) - marginLeftCoord;
        finalMarginRightCoord =
            (theVisualGraphics->getCanvasCoordWidth() / 2.0) - (coordWidth / 2.0) - marginRightCoord;
...
*/
        ...
        if (1 == 2) {
            ...
            if (this->stagePosition.verticalAlignment == kTopAligned) {
                ...
                bottom =
                    theVisualGraphics->getMaxBottomCoordOfCanvas() + marginBottomCoord +
                    (((theVisualGraphics->getCanvasCoordHeight() - marginBottomCoord) / 2.0) - (coordHeight / 2.0));
                if ((minMarginBottomCoord > marginBottomCoord)
                    && ((theVisualGraphics->getMaxBottomCoordOfCanvas() - bottom) < minMarginBottomCoord)) {
                    bottom = theVisualGraphics->getMaxBottomCoordOfCanvas() + minMarginBottomCoord;
                }
            } else if (this->stagePosition.verticalAlignment == kBottomAligned) {
            ...
            if (this->stagePosition.horizontalAlignment == kLeftAligned) {
                ...
                left =
                    theVisualGraphics->getMaxLeftCoordOfCanvas() + marginLeftCoord +
                    (((theVisualGraphics->getCanvasCoordWidth() - marginLeftCoord) / 2.0) - (coordWidth / 2.0));
                if ((minMarginLeftCoord > marginLeftCoord)
                    && ((theVisualGraphics->getMaxLeftCoordOfCanvas() - left) < minMarginLeftCoord)) {
                    left = theVisualGraphics->getMaxLeftCoordOfCanvas() + minMarginLeftCoord;
                }
            } else if (this->stagePosition.horizontalAlignment == kRightAligned) {
            ...
            if (top > (theVisualGraphics->getMaxTopCoordOfCanvas() - minMarginTopCoord)) {
                ...
                if ((this->scalingBehaviour & kPreserveAspectRatio) == kPreserveAspectRatio) {
                    ...
                    if (this->stagePosition.horizontalAlignment == kLeftAligned) {
                        ...
                        left =
                            (theVisualGraphics->getMaxLeftCoordOfCanvas() + marginLeftCoord +
                             (theVisualGraphics->getCanvasCoordWidth() / 2.0)) - (coordWidth / 2.0);
