...
OSStatus TrackLyrics::makeTextureOfTrackLyrics(const VisualString & trackLyrics)
{
    ...
    stringStyle.fontColor.r =
        VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsFontColorRedFloat);
    stringStyle.fontColor.g =
        VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsFontColorGreenFloat);
    stringStyle.fontColor.b =
        VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsFontColorBlueFloat);
...
void TrackLyrics::calcPositionOnScreen()
{
    ...
    for (UInt8 i = 0; i < 4; i++) {
        ...
        case 0:
            aVertexColor.r =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorTopLeftRed);
            aVertexColor.g =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorTopLeftGreen);
            aVertexColor.b =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorTopLeftBlue);
            aVertexColor.a =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorTopLeftAlpha);
            this->trackLyricsAsset.setTopLeftFrontVertexColor(aVertexColor);
            break;
        case 1:
            aVertexColor.r =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorBottomLeftRed);
            aVertexColor.g =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorBottomLeftGreen);
            aVertexColor.b =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorBottomLeftBlue);
            aVertexColor.a =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorBottomLeftAlpha);
            this->trackLyricsAsset.setBottomLeftFrontVertexColor(aVertexColor);
            break;
        case 2:
            aVertexColor.r =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorBottomRightRed);
            aVertexColor.g =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorBottomRightGreen);
            aVertexColor.b =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorBottomRightBlue);
            aVertexColor.a =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorBottomRightAlpha);
            this->trackLyricsAsset.setBottomRightFrontVertexColor(aVertexColor);
            break;
        case 3:
            aVertexColor.r =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorTopRightRed);
            aVertexColor.g =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorTopRightGreen);
            aVertexColor.b =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorTopRightBlue);
            aVertexColor.a =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackLyricsTextureColorTopRightAlpha);
    ...
    sprintf(trackLyricsLayoutPos, "top: %f, left: %f, bottom: %f, right: %f", trackLyricsAssetBox->getTopCoord(),
            trackLyricsAssetBox->getLeftCoord(), trackLyricsAssetBox->getBottomCoord(),
            trackLyricsAssetBox->getRightCoord());
