...
OSStatus TrackTitle::makeTextureOfTrackTitle(const VisualString & trackName)
{
    ...
    stringStyle.fontColor.r =
        VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoFontColorRedFloat);
    stringStyle.fontColor.g =
        VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoFontColorGreenFloat);
    stringStyle.fontColor.b =
        VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoFontColorBlueFloat);
...
UInt16 TrackTitle::getTrackInfoTextureHeightInPixels()
{
    ...
    heightOfTrackInfoTextureInPixels =
        VisualActorGraphics::yCoordToPixel(trackInfoAssetBox->getTopCoord()) -
        VisualActorGraphics::yCoordToPixel(trackInfoAssetBox->getBottomCoord());
...
void TrackTitle::calcPositionOnScreen()
{
    ...
    for (UInt8 i = 0; i < 4; i++) {
        ...
        case 0:
            aVertexColor.r =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorTopLeftRed);
            aVertexColor.g =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorTopLeftGreen);
            aVertexColor.b =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorTopLeftBlue);
            aVertexColor.a =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorTopLeftAlpha);
            this->trackInfoAsset.setTopLeftFrontVertexColor(aVertexColor);
            break;
        case 1:
            aVertexColor.r =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorBottomLeftRed);
            aVertexColor.g =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorBottomLeftGreen);
            aVertexColor.b =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorBottomLeftBlue);
            aVertexColor.a =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorBottomLeftAlpha);
            this->trackInfoAsset.setBottomLeftFrontVertexColor(aVertexColor);
            break;
        case 2:
            aVertexColor.r =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorBottomRightRed);
            aVertexColor.g =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorBottomRightGreen);
            aVertexColor.b =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorBottomRightBlue);
            aVertexColor.a =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorBottomRightAlpha);
            this->trackInfoAsset.setBottomRightFrontVertexColor(aVertexColor);
            break;
        case 3:
            aVertexColor.r =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorTopRightRed);
            aVertexColor.g =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorTopRightGreen);
            aVertexColor.b =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorTopRightBlue);
            aVertexColor.a =
                VisualDataStore::getPreferenceValueFloat(VisualConfiguration::kTrackInfoTextureColorTopRightAlpha);
    ...
    sprintf(trackLayoutPos, "top: %f, left: %f, bottom: %f, right: %f", trackInfoAssetBox->getTopCoord(),
            trackInfoAssetBox->getLeftCoord(), trackInfoAssetBox->getBottomCoord(), trackInfoAssetBox->getRightCoord());
